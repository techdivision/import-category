...
/**
 * TechDivision\Import\Category\Utils\EntityTypeCodes
 *
 * NOTICE OF LICENSE
 *
...
class EntityTypeCodes extends \TechDivision\Import\Utils\EntityTypeCodes
{
    ...
    /**
     * Key for the product entity 'catalog_category_entity'.
     *
     * @var string
     */
    const CATALOG_CATEGORY_ENTITY = 'catalog_category_entity';
}

...
use TechDivision\Import\Category\Observers\AbstractCategoryImportObserver;
 ...
 * @link      http://www.techdivision.com
 */
class CategoryAttributeObserver extends AbstractCategoryImportObserver
{
     ...
     * @return void
     */
    protected function persistCategoryVarcharAttribute($attribute)
    {
     ...
     * @return void
     */
    protected function persistCategoryIntAttribute($attribute)
    {
     ...
     * @return void
     */
    protected function persistCategoryDecimalAttribute($attribute)
    {
     ...
     * @return void
     */
    protected function persistCategoryDatetimeAttribute($attribute)
    {
     ...
     * @return void
     */
    protected function persistCategoryTextAttribute($attribute)
    {

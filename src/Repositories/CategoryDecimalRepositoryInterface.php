...
/**
 * TechDivision\Import\Category\Repositories\CategoryDecimalRepositoryInterface
 *
 * NOTICE OF LICENSE
 *
...
/**
 * Interface for repositories providing functionality to load category decimal attribute data.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2016 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.techdivision.com
 */
interface CategoryDecimalRepositoryInterface extends RepositoryInterface
{

...
/**
 * TechDivision\Import\Category\Loaders\RawEntityLoader
 *
 * PHP version 7
 *
...
namespace TechDivision\Import\Category\Loaders;
...
class RawEntityLoader implements LoaderInterface
{
     ...
     * @var array
     */
    protected $entityTypes = array(EntityTypeCodes::CATALOG_CATEGORY_ENTITY);

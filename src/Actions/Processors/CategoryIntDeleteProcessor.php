...
/**
 * TechDivision\Import\Category\Actions\Processors\CategoryIntDeleteProcessor
 *
 * NOTICE OF LICENSE
 *
 ...
 * @link      http://www.techdivision.com
 */
class CategoryIntDeleteProcessor extends AbstractDeleteProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::DELETE_CATEGORY_INT => $this->loadStatement(SqlStatementKeys::DELETE_CATEGORY_INT)
        );
    }
}

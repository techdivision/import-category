...
/**
 * TechDivision\Import\Category\Actions\Processors\CategoryTextDeleteProcessor
 *
 * NOTICE OF LICENSE
 *
 ...
 * @link      http://www.techdivision.com
 */
class CategoryTextDeleteProcessor extends AbstractDeleteProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::DELETE_CATEGORY_TEXT => $this->loadStatement(SqlStatementKeys::DELETE_CATEGORY_TEXT)
        );
    }
}
